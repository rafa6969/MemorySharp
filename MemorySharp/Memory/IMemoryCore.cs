...
namespace Binarysharp.MemoryManagement.Memory
{
    ...
    public interface IMemoryCore
    {
        ...
        MemoryProtectionFlags ChangeMemoryProtection(SafeMemoryHandle processHandle, IntPtr address, int size, MemoryProtectionFlags protection);
        ...
        IEnumerable<MemoryBasicInformation> QueryInformationMemory(SafeMemoryHandle processHandle, IntPtr addressFrom, IntPtr addressTo);
