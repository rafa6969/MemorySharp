...
namespace Binarysharp.MemoryManagement.Memory
{
    ...
    public class MemoryCore32 : IMemoryCore
    {
        ...
        public IntPtr AllocateMemory(SafeMemoryHandle processHandle, int size, MemoryProtectionFlags protectionFlags = MemoryProtectionFlags.ExecuteReadWrite,
        ...
        public MemoryProtectionFlags ChangeMemoryProtection(SafeMemoryHandle processHandle, IntPtr address, int size, MemoryProtectionFlags protection)
        {
        ...
        public IEnumerable<MemoryBasicInformation> QueryInformationMemory(SafeMemoryHandle processHandle, IntPtr addressFrom, IntPtr addressTo)
        {
            // Check if the handle is valid
            HandleManipulator.ValidateAsArgument(processHandle, "processHandle");
        ...
        #region QueryInformationProcess
        /// <summary>
